...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
    React is a popular js library used to build rich UI's and manage a continuous flow of data and slices of state.
1. Describe component state.
    component state is the data that is loaded into a component
1. Describe props.
